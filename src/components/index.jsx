...
class Scheduler extends Component {
  ...
  static propTypes = {
    ...
    resourceItemTemplateResolver: PropTypes.func,
    resourceHeaderTemplateResolver: PropTypes.func,
  };
  ...
  render() {
    const { schedulerData, leftCustomHeader, rightCustomHeader, resourceHeaderTemplateResolver } = this.props;
                  ...
                  <table className="resource-table">
                    <thead>
                      <tr style={{ height: config.tableHeaderHeight }}>
                        <th className="header3-text">{resourceHeaderTemplateResolver ? resourceHeaderTemplateResolver(schedulerData) : resourceName}</th>
                      </tr>
                    </thead>
                  </table>
                </div>
