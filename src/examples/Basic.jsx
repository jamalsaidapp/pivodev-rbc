    ...
    render() {
        ...
        return (
            <Scheduler
                ...
                resourceItemTemplateResolver={this.resourceItemTemplateResolver}
                resourceHeaderTemplateResolver={this.resourceHeaderTemplateResolver}
            />
        );
    }

    resourceItemTemplateResolver(item, schedulerData) {
        // console.log(item)
        return (
            //your own component here
            <div>{item.slotName}</div>
        )
    }

    resourceHeaderTemplateResolver(schedulerData) {
        return (
            //your own component here
